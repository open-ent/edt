...
public class Field {
    ...
    public static final String CLASSESEXTERNALIDS = "classesExternalIds";
    public static final String CLASSESIDS = "classesIds";
    public static final String GROUPS = "groups";
    public static final String GROUPSEXTERNALIDS = "groupsExternalIds";
    ...
    public static final String IDSTARTSLOT = "idStartSlot";
    public static final String IDENDSLOT = "idEndSlot";
