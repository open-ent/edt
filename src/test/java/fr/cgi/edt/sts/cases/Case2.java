...
public class Case2 extends StsCase {
    ...
    */
    ...
    @Test
    public void importSts_Should_Import_OnlyOneCourseWithAGroup(TestContext ctx) {
        String path = "./src/main/resources/sts/tests/case2";
